...
| --- | --- | --- | --- | --- | --- | --- |
| 新建患者 | patient.create | `fill_basic_info`, `submit_create_patient` | `name, gender, patient_id, eeg_id` | `src/heeg_auto/modules/patient/新建患者.py` | `src/heeg_auto/elements/patient/新建患者.yaml` | 样板模块 |
