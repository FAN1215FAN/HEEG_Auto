...
from docs.examples.starter_skeleton.submodules.patient.fill_basic_info import fill_basic_info
from docs.examples.starter_skeleton.submodules.patient.fill_identifiers import fill_identifiers
from docs.examples.starter_skeleton.submodules.patient.submit_create_patient import submit_create_patient
